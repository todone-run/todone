...
## [0.8.0](https://github.com/todone-run/todone/compare/plugin-github-v0.7.2...plugin-github-v0.8.0) (2026-09-13)


### ⚠ BREAKING CHANGES

* todone: Plugin loses warn/info/debug and report* hooks and is now { name, checkMatch? }. RunOptions.forcedReporter is replaced by RunOptions.reporter (new Reporter type on the main entry); run() without a reporter is silent. PluginContext logging now writes to the console instead of fanning out to plugins. @todone/plugin-github: the context, actions, and createIssues options and their features are removed; only token remains. githubPlugin() returns a single Plugin instead of an array.
...
* replace plugin reporting hooks with a standalone Reporter ([#100](https://github.com/todone-run/todone/issues/100)) ([087a7ee](https://github.com/todone-run/todone/commit/087a7eebbba1cfcfb7a50d0992c9e08c04a6cac3))
...
* make importing and resolution faster ([#117](https://github.com/todone-run/todone/issues/117)) ([c8b298c](https://github.com/todone-run/todone/commit/c8b298c78ce041bceb6fec59cd2e2748f2f2e87b))
